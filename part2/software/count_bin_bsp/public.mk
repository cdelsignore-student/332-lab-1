...
SOPCINFO_FILE := $(ABS_BSP_ROOT_DIR)/../../count_bin.sopcinfo
...
# Design Name 
# setting SOPC_NAME is count_bin
SOPC_NAME := count_bin
...
# setting SOPC_SYSID_BASE_ADDRESS is 0x8001050
SOPC_SYSID_FLAG += --sidp=0x8001050
ELF_PATCH_FLAG  += --sidp 0x8001050

# The SOPC Timestamp 
# setting SOPC_TIMESTAMP is 1708632282
SOPC_SYSID_FLAG += --timestamp=1708632282
ELF_PATCH_FLAG  += --timestamp 1708632282
