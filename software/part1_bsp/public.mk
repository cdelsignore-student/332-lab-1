...
SOPCINFO_FILE := $(ABS_BSP_ROOT_DIR)/../../lab1.sopcinfo
...
# setting SOPC_SYSID_BASE_ADDRESS is 0x3008
SOPC_SYSID_FLAG += --sidp=0x3008
ELF_PATCH_FLAG  += --sidp 0x3008

# The SOPC Timestamp 
# setting SOPC_TIMESTAMP is 1707533549
SOPC_SYSID_FLAG += --timestamp=1707533549
ELF_PATCH_FLAG  += --timestamp 1707533549
